...
class Pointcloud_Seg:
    ...
    def run(self,_):
        ...
        if error == False:
            ...
            print("")
            print('Pc processing took seconds. Split into:' + str((self.T_total)/self.n_pc))
            print('Reading -------- seconds ' + str((self.T_read)/self.n_pc) + '  percentaje: ' + str((self.T_read/self.T_total)*100))
            print('Inference ------ seconds ' + str((self.T_inferference)/self.n_pc) + '  percentaje: ' + str((self.T_inferference/self.T_total)*100))
            print('Instances ------ seconds ' + str((self.T_instaces)/self.n_pc) + '  percentaje: ' + str((self.T_instaces/self.T_total)*100))
            print(' - Valve - seconds ' + str((self.T_instaces_valve)/self.n_pc) + '  percentaje: ' + str((self.T_instaces_valve/self.T_total)*100))
            print(' - Pipe -- seconds ' + str((self.T_instaces_pipe)/self.n_pc) + '  percentaje: ' + str((self.T_instaces_pipe/self.T_total)*100))
            print('Info ----------- seconds ' + str((self.T_info)/self.n_pc) + '  percentaje: ' + str((self.T_info/self.T_total)*100))
            print(' - Valve - seconds ' + str((self.T_info_valve)/self.n_pc) + '  percentaje: ' + str((self.T_info_valve/self.T_total)*100))
            print(' - Pipe -- seconds ' + str((self.T_info_pipe)/self.n_pc) + '  percentaje: ' + str((self.T_info_pipe/self.T_total)*100))
            print('Refine --------- seconds ' + str((self.T_ref)/self.n_pc) + '  percentaje: ' + str((self.T_ref/self.T_total)*100))
            print(' - Valve - seconds ' + str((self.T_ref_valve)/self.n_pc) + '  percentaje: ' + str((self.T_ref_valve/self.T_total)*100))
            print(' - Pipe -- seconds ' + str((self.T_ref_pipe)/self.n_pc) + '  percentaje: ' + str((self.T_ref_pipe/self.T_total)*100))
            print('Publish -------- seconds ' + str((self.T_publish)/self.n_pc) + '  percentaje: ' + str((self.T_publish/self.T_total)*100))
